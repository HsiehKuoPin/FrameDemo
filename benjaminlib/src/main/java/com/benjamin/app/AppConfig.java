...
//			DEVICE_ID = AppUtil.getDeviceId(context);
	...
	public static void initAppFolder(Context context){
		...
		//缓存目录
		DATA_CACHE_PATH = AppUtil.isSDCard() ? Environment
		...
		//图片目录
		IMAGE_PATH = (AppUtil.isSDCard() ? Environment.getExternalStorageDirectory().getPath()
				+ File.separator
				+ DEFUALT_CACHE_DIR
				+ IMAGE_DIR_NAME
				+ File.separator
				...
				+ File.separator);
		//图片目录
		IMAGE_PATH_NOMEDIA = (AppUtil.isSDCard() ? Environment
				.getExternalStorageDirectory().getPath()
				+ File.separator
				+ DEFUALT_CACHE_DIR
				+ NOMEDIA
				...
				+ File.separator);
		//音频目录
		VOICE_PATH = (AppUtil.isSDCard() ? Environment
				.getExternalStorageDirectory().getPath()
				+ File.separator
				+ DEFUALT_CACHE_DIR
				+ NOMEDIA
				...
				+ File.separator);
		//视频目录
		VIDEO_PATH = (AppUtil.isSDCard() ? Environment
				.getExternalStorageDirectory().getPath()
				+ File.separator
				+ DEFUALT_CACHE_DIR
				+ NOMEDIA
		...
		//错误日志目录
		LOG_PATH = (AppUtil.isSDCard() ? Environment
				.getExternalStorageDirectory().getPath()
				+ File.separator
				+ DEFUALT_CACHE_DIR
				+ LOG_DIR_NAME
